...
def run_two_phase_eval(limit_per_task: int = DEFAULT_LIMIT_PER_TASK):
    import json
    import os
    import subprocess
    import sys
...
def main(limit_per_task: int = DEFAULT_LIMIT_PER_TASK):
    import json
    summary = run_two_phase_eval.remote(limit_per_task=limit_per_task)
